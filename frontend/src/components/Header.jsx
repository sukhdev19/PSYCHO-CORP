...
const Header = () => {
    return (
        <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20 min-h-[80vh]'>
            ...
            <div className='md:w-1/2 relative'>
                <img
                    className='absolute bottom-0 left-0 w-3/4 h-auto object-cover rounded-lg'
