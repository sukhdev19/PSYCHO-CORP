...
const ChatbotPopup = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      ...
      {isOpen && (
        <div className="w-80 rounded-lg shadow-lg mt-2 p-4 flex flex-col text-gray-900 dark:text-white bg-blue-600 dark:bg-gray-800">
          {/* Chatbot header */}
          <h2 className="text-2xl text-center mb-3 text-white">Chatbot</h2>
          ...
          <div className="flex items-center mt-2 space-x-2">
            <input
              ...
              onKeyDown={(e) => e.key === 'Enter' && sendMessage()} // Trigger send on Enter key press
